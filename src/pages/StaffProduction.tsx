  ...
  return (
    <>
      ...
      <p className={styles.subtitle}>
        Orders for fulfilment and delivery. Use <Link to="/staff/orders">Orders</Link> for full list and status updates.
      </p>
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.id}>
                  ...
                  <td>
                    <Link to={`/staff/orders/${order.id}`} className={styles.link}>{t('orderDetails')}</Link>
                  </td>
                </tr>
              ))}
            </tbody>
