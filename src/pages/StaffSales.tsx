...
export default function StaffSales() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      navigate(`/staff/orders/${order.id}`, { replace: true })
    } catch (e) {
  ...
  if (!token) {
    return (
      <div className={styles.wrap}>
        <Link to="/staff/orders" className={styles.backLink}>
          ← Orders
        </Link>
    ...
    <div className={styles.wrap}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.btnRow}>
          ...
          <Link to="/staff/orders" className={styles.btnSecondary} style={{ padding: '10px 18px' }}>
            Cancel
          </Link>
        </div>
      </form>
